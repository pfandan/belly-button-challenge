...
function init() {
    ...
    d3.json(url).then((data) => {
        ...
        renderMetadata(sample_one);
        renderBarChart(sample_one);
        renderBubbleChart(sample_one);
        // renderGaugeChart(sample_one);
...
// Function that renders the bar chart
...
// Function that renders the bubble chart
